...
func newOrderGoods(db *gorm.DB, opts ...gen.DOOption) orderGoods {
	...
	_orderGoods.CategoryID = field.NewInt64(tableName, "category_id")
	_orderGoods.CategoryName = field.NewString(tableName, "category_name")
	_orderGoods.GoodsID = field.NewInt64(tableName, "goods_id")
	_orderGoods.GoodsName = field.NewString(tableName, "goods_name")
	_orderGoods.GoodsPicture = field.NewString(tableName, "goods_picture")
	_orderGoods.GoodsPrice = field.NewFloat64(tableName, "goods_price")
	_orderGoods.GoodsNum = field.NewInt64(tableName, "goods_num")
	_orderGoods.DeletedAt = field.NewField(tableName, "deleted_at")
	_orderGoods.CreatedAt = field.NewTime(tableName, "created_at")
	_orderGoods.UpdatedAt = field.NewTime(tableName, "updated_at")
...
func (o *orderGoods) updateTableName(table string) *orderGoods {
	...
	o.GoodsPicture = field.NewString(table, "goods_picture")
...
func (o *orderGoods) WithContext(ctx context.Context) IOrderGoodsDo {
...
func (o *orderGoods) fillFieldMap() {
	...
	o.fieldMap["goods_picture"] = o.GoodsPicture
...
func (o orderGoodsDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) IOrderGoodsDo {
