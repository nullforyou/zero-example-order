...
func newCategory(db *gorm.DB, opts ...gen.DOOption) category {
	...
	_category.CategoryID = field.NewInt64(tableName, "category_id")
	_category.CategoryPid = field.NewInt64(tableName, "category_pid")
	_category.CategoryName = field.NewString(tableName, "category_name")
	_category.CategoryPicture = field.NewString(tableName, "category_picture")
	_category.DiffHash = field.NewString(tableName, "diff_hash")
	_category.IsRecommend = field.NewInt64(tableName, "is_recommend")
	_category.CategoryStatus = field.NewInt64(tableName, "category_status")
	_category.OperationUser = field.NewInt64(tableName, "operation_user")
	...
	_category.GoodsSort = field.NewInt64(tableName, "goods_sort")
...
type category struct {
	...
	ALL             field.Asterisk
	ID              field.Int64
	CategoryID      field.Int64  // 第三方Id
	CategoryPid     field.Int64  // 第三方父级Id
	CategoryName    field.String // 分类名称
	CategoryPicture field.String // 分类图片
	DiffHash        field.String // 值hash
	IsRecommend     field.Int64  // 是否推荐1:已推荐;0:未推荐;
	CategoryStatus  field.Int64  // 分类状态1：使用；0：禁用；
	OperationUser   field.Int64  // 操作人id
	DeletedAt       field.Field
	CreatedAt       field.Time
	UpdatedAt       field.Time
	GoodsSort       field.Int64
...
func (c *category) updateTableName(table string) *category {
	...
	c.CategoryPid = field.NewInt64(table, "category_pid")
	c.CategoryName = field.NewString(table, "category_name")
	c.CategoryPicture = field.NewString(table, "category_picture")
	c.DiffHash = field.NewString(table, "diff_hash")
	c.IsRecommend = field.NewInt64(table, "is_recommend")
	c.CategoryStatus = field.NewInt64(table, "category_status")
	c.OperationUser = field.NewInt64(table, "operation_user")
	c.DeletedAt = field.NewField(table, "deleted_at")
	c.CreatedAt = field.NewTime(table, "created_at")
	c.UpdatedAt = field.NewTime(table, "updated_at")
	c.GoodsSort = field.NewInt64(table, "goods_sort")
...
func (c *category) fillFieldMap() {
	...
	c.fieldMap["category_pid"] = c.CategoryPid
	c.fieldMap["category_name"] = c.CategoryName
	c.fieldMap["category_picture"] = c.CategoryPicture
	c.fieldMap["diff_hash"] = c.DiffHash
	c.fieldMap["is_recommend"] = c.IsRecommend
	c.fieldMap["category_status"] = c.CategoryStatus
	c.fieldMap["operation_user"] = c.OperationUser
	c.fieldMap["deleted_at"] = c.DeletedAt
	c.fieldMap["created_at"] = c.CreatedAt
	c.fieldMap["updated_at"] = c.UpdatedAt
	c.fieldMap["goods_sort"] = c.GoodsSort
}
