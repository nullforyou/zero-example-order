...
func newOrderPayment(db *gorm.DB, opts ...gen.DOOption) orderPayment {
	...
	_orderPayment.MemberID = field.NewInt64(tableName, "member_id")
	_orderPayment.BusinessType = field.NewString(tableName, "business_type")
	_orderPayment.OrderSn = field.NewString(tableName, "order_sn")
	_orderPayment.PaymentStatus = field.NewInt64(tableName, "payment_status")
	_orderPayment.PaymentSn = field.NewString(tableName, "payment_sn")
	_orderPayment.PaymentAmount = field.NewFloat64(tableName, "payment_amount")
	_orderPayment.PaymentType = field.NewInt64(tableName, "payment_type")
	_orderPayment.PaymentParams = field.NewString(tableName, "payment_params")
	_orderPayment.PaymentResult = field.NewString(tableName, "payment_result")
...
type orderPayment struct {
	...
	ALL           field.Asterisk
	ID            field.Int64
	OrderID       field.Int64   // 订单id|补款单id
	MemberID      field.Int64   // 用户id
	BusinessType  field.String  // 业务类型
	OrderSn       field.String  // 销巴订单号|补款单号，未加索引，不能做条件字句
	PaymentStatus field.Int64   // 支付单状态1：已创建待支付；2：已支付；3：支付失败；4:支付异常,需要人工介入;
	...
	PaymentParams field.String  // 创建支付订单时的入参
	PaymentResult field.String  // 创建支付订单时的响应
...
func (o *orderPayment) updateTableName(table string) *orderPayment {
	...
	o.BusinessType = field.NewString(table, "business_type")
	...
	o.PaymentParams = field.NewString(table, "payment_params")
	o.PaymentResult = field.NewString(table, "payment_result")
...
func (o *orderPayment) fillFieldMap() {
	...
	o.fieldMap["payment_params"] = o.PaymentParams
	o.fieldMap["payment_result"] = o.PaymentResult
